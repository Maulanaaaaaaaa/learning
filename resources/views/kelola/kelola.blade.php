        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#tambahMahasiswaModal">Tambah
                        Mahasiswa</button>
                </div>

                <form method="GET" action="{{ route('kelola.index') }}" class="mb-3">
                    ...
                    <tbody>
                        @forelse ($users as $index => $user)
                            <tr>
                                ...
                                <td>
                                    <!-- Update Status -->
                                    <form action="{{ route('kelola.update-status', $user->id) }}" method="POST"
    ...
    <div class="modal fade" id="tambahMahasiswaModal" tabindex="-1" aria-labelledby="tambahMahasiswaModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('kelola.store') }}">
                    @csrf
